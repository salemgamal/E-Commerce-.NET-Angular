...
{
    /// <inheritdoc />
    public partial class addIdentityV : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "static-guid-1", "Admin", "ADMIN" },
                    { "2", "static-guid-2", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "100", 0, "Head Office", "HQ", "static-guid-admin", "Global", "admin@example.com", true, "System", "Administrator", false, null, "ADMIN@EXAMPLE.COM", "ADMIN@EXAMPLE.COM", "AQAAAAIAAYagAAAAEIjJh6/LXD2Bg+3MJGc+CmiaE471FJWBEmlTQ/1OhqkFw0NIgG/beU7wkTfmnuQ/sQ==", null, false, "STATIC-ADMIN-SECURITYSTAMP-001", false, "admin@example.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Latest model smartphone", "Smartphone", 699.99m, 9.99m },
                    { 2, 1, "High-performance laptop", "Laptop", 1299.99m, 9.99m },
                    { 3, 2, "Comfortable cotton t-shirt", "T-shirt", 19.99m, 9.99m },
                    { 4, 3, "Energy-efficient washing machine", "Washing Machine", 499.99m, 9.99m }
                });
